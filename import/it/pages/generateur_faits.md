...
lastmod: '2024-04-04T18:07:51'
draft: false
slug: generateur_faits
original_id: 7080
original_link: https://www.nc-wiki.ch/it/generateur_faits/
original_lang: it
original_type: pages
description: 'Generatore per il sub-test „Memorizzazione dei fatti“ (attualmente disponibile solo in francese) Vous trouverez ici toutes les explications nécessaires au téléchargement et à l’utilisation du générateur. Si vous préférez télécharger directement des exercices déjà prêts, il y en a ici. Prérequis pour pouvoir utiliser le générateur : Microsoft Excel installé Téléchargement du générateur (MacOS) Téléchargez […]'
author: ma_ri
menu_order: 0
---
